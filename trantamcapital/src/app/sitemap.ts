...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = [
    ...
    { path: "/forex-broker/broker-d", priority: 0.7 },
    { path: "/forex-broker/broker-e", priority: 0.7 },
    { path: "/forex-broker/broker-f", priority: 0.7 },
    ...
    { path: "/crypto-exchange/exchange-d", priority: 0.7 },
    { path: "/crypto-exchange/exchange-e", priority: 0.7 },
    { path: "/crypto-exchange/exchange-f", priority: 0.7 },
    { path: "/binary-option", priority: 0.8 },
    { path: "/binary-option/platform-a", priority: 0.7 },
    { path: "/binary-option/platform-b", priority: 0.7 },
    { path: "/proprietary-trading-firm", priority: 0.8 },
